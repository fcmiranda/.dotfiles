...
o.bind("SUPER + SHIFT + RETURN", "Browser", "google-chrome-stable")
o.bind("SUPER + SHIFT + B", "New browser window", "google-chrome-stable --new-window")
o.bind("SUPER + SHIFT + ALT + B", "Browser (private)", "google-chrome-stable --incognito")
