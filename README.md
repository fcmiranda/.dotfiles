...
- [docs/FEATURES.md](docs/FEATURES.md) — notable behaviors, including click-and-hold copy inside
  tmux, scrollback capture to Neovim, Zsh Vi mode (`vi-cmd-mode`) with custom surrounds and Starship integration, automatic monitor management via Kanshi, agent status in the tmux status bar, and theme-aware styling.
